# Consuming VJRA Design System in Expo apps

Read `artifacts/vjra-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/vjra-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/vjra-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/vjra-ds/lib/native-theme";
import { useColors } from "@workspace/vjra-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/vjra-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/vjra-ds/components/native/badge";
import { Button } from "@workspace/vjra-ds/components/native/button";
import { Card } from "@workspace/vjra-ds/components/native/card";
```
...
Import and render
`@workspace/vjra-ds/components/native/button`, then run Expo
